...
class MachinesPage extends StatelessWidget {
  ...
  final List<Map<String, String>> _items = const [
    {'title': 'Máquina de reparación BGA', 'image': kLaptopImagePath},
    {'title': 'Estación de soldadura', 'image': kLaptopImagePath},
    {'title': 'Extractor de chip', 'image': kLaptopImagePath},
  ];
