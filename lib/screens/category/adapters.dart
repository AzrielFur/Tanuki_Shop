...
class AdaptersPage extends StatelessWidget {
  ...
  final List<Map<String, String>> _items = const [
    {'title': 'Adaptador HDMI a USB-C', 'image': kLaptopImagePath, 'description': 'HDMI 4K a USB-C', 'price': 'USD 19'},
    {'title': 'Adaptador de corriente', 'image': kLaptopImagePath, 'description': 'Salida 65W, USB-C', 'price': 'USD 29'},
    {'title': 'Adaptador OTG', 'image': kCellImagePath, 'description': 'Conecta USB a celular', 'price': 'USD 9'},
  ];
          ...
          child: Column(
            children: [
              ...
              Container(
                ...
                child: const Text('ADAPTADORES', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.black)),
              ),
              const SizedBox(height: 16),
              // Search bar
              GestureDetector(
