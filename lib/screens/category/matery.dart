...
class MateryPage extends StatelessWidget {
  const MateryPage({super.key});

  final List<Map<String, String>> _items = const [
    {'title': 'Pasta térmica', 'image': kLaptopImagePath, 'description': 'Mejora la disipación térmica', 'price': 'USD 7'},
    {'title': 'Lámpara UV', 'image': kLaptopImagePath, 'description': 'Para pegado y reparaciones', 'price': 'USD 25'},
    {'title': 'Herramientas pequeñas', 'image': kLaptopImagePath, 'description': 'Kit de precisión', 'price': 'USD 15'},
  ];
          ...
          child: Column(
            children: [
              ...
              Container(
                ...
                child: const Text('MATERIALES DE REPARACION', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.black)),
              ),
              const SizedBox(height: 16),
              // Search bar
              GestureDetector(
